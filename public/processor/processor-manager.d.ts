...
export declare class ProcessorManager implements HealthMonitorProcessor {
    ...
    constructor({ onFaceDetected, onVitalSign, onFinalResults, onError, onWarning, resolveFeatures, logAlgoMeasurements, doLogging, doPerformance, doRecording, doMeasuring, sdkLogger, subjectDemographic, cameraId, }: ProcessorOptions);
    init(): Promise<void>;
